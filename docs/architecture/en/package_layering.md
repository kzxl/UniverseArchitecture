# Package Layering Guide (Mono vs Distributed)
**Project**: Universe Architecture v4.0

## Triết lý cốt lõi: "Chỉ dùng những gì cần thiết"

Universe Architecture **KHÔNG** bắt buộc dùng microservices. Kiến trúc được thiết kế theo lớp (Layers), mỗi lớp là **opt-in** — dự án Monolith chỉ cần dùng Core, còn các tính năng nâng cao chỉ khi thực sự cần.
